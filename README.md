...
** OBS: deve ser executado em paralelo com o projeto [appapi](https://github.com/rukaLukas/appapi) para ter acesso ao banco que possui os dados a serem exportados.
